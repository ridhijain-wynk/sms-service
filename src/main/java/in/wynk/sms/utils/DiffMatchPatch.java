...
public class DiffMatchPatch {
    ...
    public LinkedList<Diff> getDiffLinkedList (String template, String filledTemplate) {
        LinkedList<DiffMatchPatch.Diff> diff = this.diff_main(template, filledTemplate);
        // Result: [(-1, "Hell"), (1, "G"), (0, "o"), (1, "odbye"), (0, " World.")]
        this.diff_cleanupEfficiency(diff);
    ...
    /*public static void main (String[] args) {
        for(int i=0; i< 100000; i++){
            ...
            String filledTemplate = "<#> Hi! Your music PIN is 6192. Keep grooving with Wynk :)\n" +
                    "/NvYD4LFr69";
            String template = "<#> Hi! Your music PIN is {#var#}. Keep grooving with Wynk! {#var#}";
            getVariablesMap(template, filledTemplate, templateTranslation, "");
            System.out.println("Time taken in ms- "+(System.currentTimeMillis() - startTime)+ " start - "+startTime+" end - "+System.currentTimeMillis());
        }
    }*/
}