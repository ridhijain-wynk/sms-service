...
public class SendSmsRequest implements Serializable {
	...
	private static final long serialVersionUID = 14839L;
	...
	public boolean validRequest() {
		...
		if (message == null || priority == null || msisdn == null || source == null) {
			return false;
		}
		...
		if (! EnumUtils.isValidEnum(SMSPriority.class, priority)) 
			return false;
		
//		try {
//			SMSUtils.getTenDigitMsisdn(msisdn);
//		} catch (Exception e) {
//			return false;
//		}
